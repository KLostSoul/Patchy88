...
## 한글판 결과 MD5 / SHA-256 (CCD/IMG/SUB 기준값 확정)

| 파일 | MD5 | SHA-256 |
|---|---|---|
| CCD | `80273154A2DAF2D107A282B353A86246` | `5512EFCEC20279753E1C6FEF0C5AAE37F2F3F05BB3AE3900B5DB0F688D4A67AC` |
| IMG | `32D1646E31EEF1EE55E587DBDD6FF864` | `7D5067467E5C4715A840C088F84656EED27908A63BCF77F27069B80D5FBA4016` |
| SUB | `E45923398B1D150F71E6056BD0974D15` | `C20C93FF3A2CF3A1E3A18B5F8046EC6F6198A916B417A01678B0B9D10EED9046` |

일본판의 CCD와 SUB는 한글판 결과와 해시가 동일합니다. 영문판에서는 CCD·IMG·SUB 모두 결과 해시가 다릅니다. 두 판본별로 제공된 xdelta 패치 3개를 각각 사용합니다. 원본 전체는 MD5·SHA-256으로 검사하지만, 1.01 IMG도 제공받은 전체 MD5와 SHA-256으로 검증합니다. 66개 VCDIFF 윈도우 Adler-32와 출력 크기는 보조 데이터로 보존합니다.
...
## v1.01 업데이트 (사용자 제공 패치 및 결과 전체 해시 기준)
...
새 IMG는 이전 결과와 다른 데이터이므로 **1.00 IMG의 MD5·SHA-256을 재사용하지 않습니다.** v1.01의 일본판과 영문판 IMG 패치에서 추출한 66개 출력 윈도우 Adler-32가 모두 동일하며, 전체 출력 크기는 551,779,200바이트입니다. 새 IMG 기대 MD5 `32D1646E31EEF1EE55E587DBDD6FF864`, SHA-256 `7D5067467E5C4715A840C088F84656EED27908A63BCF77F27069B80D5FBA4016`을 제공받아 출력 전체 해시와 비교하도록 변경했습니다. 다만 실제 원본 CD 이미지를 제공받지 못했으므로 일본판·영문판의 종단 간 패치 시험은 완료하지 못했습니다.
